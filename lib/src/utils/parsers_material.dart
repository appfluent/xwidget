...
Alignment? parseAlignment(String? value) {
  if (value != null && value.isNotEmpty) {
    switch (value) {
      ...
      default:
        throw Exception("Problem parsing Alignment value: $value");
    }
  }
  return null;
}
...
AlignmentDirectional? parseAlignmentDirectional(String? value) {
  if (value != null && value.isNotEmpty) {
    switch (value) {
      ...
      default:
        throw Exception(
          "Problem parsing AlignmentDirectional "
          "value: $value",
        );
    }
  }
...
Curve? parseCurve(String? value) {
  if (value != null && value.isNotEmpty) {
    switch (value) {
      ...
      default:
        throw Exception("Problem parsing Curve value: $value");
    }
  }
  return null;
}
...
EdgeInsets? parseEdgeInsets(String? value) {
  ...
  if (doubles != null && doubles.isNotEmpty) {
    switch (doubles.length) {
      ...
      case 4:
        return EdgeInsets.fromLTRB(doubles[0], doubles[1], doubles[2], doubles[3]);
    }
...
InputBorder? parseInputBorder(String? value) {
  if (value != null && value.isNotEmpty) {
    switch (value) {
      ...
      default:
        throw Exception("Problem parsing InputBorder value: $value");
    }
  }
  return null;
}
...
Offset? parseOffset(String? value) {
  ...
  if (doubles != null && doubles.isNotEmpty) {
    switch (doubles.length) {
      case 1:
        return Offset(doubles[0], doubles[0]);
      case 2:
        return Offset(doubles[0], doubles[1]);
    }
...
TextDecoration? parseTextDecoration(String? value) {
  if (value != null && value.isNotEmpty) {
    switch (value) {
      ...
      default:
        throw Exception("Problem parsing TextDecoration value: $value");
    }
  }
  return null;
}
...
TextInputType? parseTextInputType(String? value) {
  if (value != null && value.isNotEmpty) {
    switch (value) {
      ...
      default:
        throw Exception("Problem parsing TextInputType value: $value");
    }
  }
  return null;
}
...
VisualDensity? parseVisualDensity(String? value) {
  ...
  if (doubles != null && doubles.isNotEmpty) {
    switch (doubles.length) {
      case 1:
        return VisualDensity(horizontal: doubles[0], vertical: doubles[0]);
      case 2:
        return VisualDensity(horizontal: doubles[0], vertical: doubles[1]);
    }
