...
class VariableTag implements Tag {
  ...
  Children? processTag(
    ...
    if (varName == null || varName.isEmpty) {
      throw Exception("<$name> 'name' attribute is required.");
    }

    // 'value' is a required attribute - check element attributes because
    // the value could be null.
    if (element.getAttribute("value") == null) {
      throw Exception("<$name> 'value' attribute is required.");
    }
